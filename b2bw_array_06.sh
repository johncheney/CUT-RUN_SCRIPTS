...
# INPUT_DIR="../results/nordin/unmerged"
INPUT_DIR="$BAM_DIR"
# INPUT_DIR="$BAI_DIR"
OUTPUT_DIR="../results/nordin/unmerged"
...
# samtools view -hbS -F 0x04 $INPUT_DIR/${SAMPLE_NAME} > $BAM_DIR/${SAMPLE_NAME}.bam
# samtools sort -o $BAM_DIR/${SAMPLE_NAME}_sorted.bam $INPUT_DIR/${SAMPLE_NAME}
